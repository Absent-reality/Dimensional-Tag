...
//          new Character(00, "Unknown"             , "Unknown",                                 "",                 new List<string>() { }),
            ...
            new Character(57, "Sonic the Hedgehog"  , "Sonic the Hedgehog",                      "sonic_the_hedgehog.png",         new List<string>() { "Speed","Grind Rails","Acrobat","Super Strength","Super Transformation","Invulnerability","Laser Deflector","Super Jump" }),
//          new Character(58, "Unknown"             , "Unknown",                                 "",                               new List<string>() { "Unknown" }),
            ...
            new Character(72, "Beetlejuice"         , "Beetlejuice",                             "beetlejuice_char.png",           new List<string>() { "Mind Control","Magic","Slurp Access","Illumination","Mini Access","Super Strength","Apparate Access" }),

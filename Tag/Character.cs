...
//          new Character(73, "Unknown"             , "Unknown",                                 "",                               new List<string>() { "Unknown" }),
            new Character(74, "Blossom"             , "The Powerpuff Girls",                     "blossom",                        ["Flying","Lantern Constructs","Laser","Freeze Breath","Energy Shield","Intelligence","Super Strength","Dive","X-Ray Vision","Hearts Regenerate"]),
